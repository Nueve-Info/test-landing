            ...
            <div className="relative">
              ...
              <div className="relative bg-[#111] border border-white/10 rounded-3xl p-8 shadow-2xl">
                <div className="flex items-center gap-4 mb-8 border-b border-white/5 pb-6">
                  ...
                  <div>
                    <div className="text-white font-bold text-lg">1-Day Sprint System</div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">Hour-by-Hour Schedule</div>
                      <div className="text-gray-400 text-xs">Zero-guesswork timeline</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                    <svg className="w-5 h-5 text-[#FD7E35] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">"Good Enough" Checklist</div>
                      <div className="text-gray-400 text-xs">Stop perfecting, start shipping</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                    <svg className="w-5 h-5 text-[#FD7E35] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">Rapid Application System</div>
                      <div className="text-gray-400 text-xs">Send 10 apps per day</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                    <svg className="w-5 h-5 text-[#FD7E35] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">3-Second Scan Template</div>
                      <div className="text-gray-400 text-xs">Metrics-first case studies</div>
                    </div>
                  </div>
                </div>
              </div>
