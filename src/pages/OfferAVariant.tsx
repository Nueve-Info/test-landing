            ...
            <div className="relative">
              ...
              <div className="relative bg-[#111] border border-white/10 rounded-3xl p-8 shadow-2xl">
                <div className="flex items-center gap-4 mb-8 border-b border-white/5 pb-6">
                  ...
                  <div>
                    <div className="text-white font-bold text-lg">Anti-Template Framework</div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">1-Day Portfolio Rewrite</div>
                      <div className="text-gray-400 text-xs">Complete restructure system</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                    <svg className="w-5 h-5 text-[#FD7E35] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">AI Narrative Reframing</div>
                      <div className="text-gray-400 text-xs">Transform your case studies</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                    <svg className="w-5 h-5 text-[#FD7E35] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">3-Second Scan Checklist</div>
                      <div className="text-gray-400 text-xs">Pass the recruiter test</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                    <svg className="w-5 h-5 text-[#FD7E35] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">Before/After Examples</div>
                      <div className="text-gray-400 text-xs">Real portfolio transformations</div>
                    </div>
                  </div>
                </div>
              </div>
