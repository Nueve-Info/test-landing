            ...
            <div className="relative">
              ...
              <div className="relative bg-[#111] border border-white/10 rounded-3xl p-8 shadow-2xl">
                <div className="flex items-center gap-4 mb-8 border-b border-white/5 pb-6">
                  ...
                  <div>
                    <div className="text-white font-bold text-lg">Portfolio Architecture</div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">Scan Optimization Checklist</div>
                      <div className="text-gray-400 text-xs">Win the first 3 seconds</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                    <svg className="w-5 h-5 text-[#FD7E35] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">Metrics-First Framework</div>
                      <div className="text-gray-400 text-xs">Structure for impact</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                    <svg className="w-5 h-5 text-[#FD7E35] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">Headline Formula</div>
                      <div className="text-gray-400 text-xs">Turn process into outcomes</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                    <svg className="w-5 h-5 text-[#FD7E35] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">Above-the-Fold Blueprint</div>
                      <div className="text-gray-400 text-xs">Maximize first impressions</div>
                    </div>
                  </div>
                </div>
              </div>
