            ...
            <div className="relative">
              ...
              <div className="relative bg-[#111] border border-white/10 rounded-3xl p-8 shadow-2xl">
                <div className="flex items-center gap-4 mb-8 border-b border-white/5 pb-6">
                  ...
                  <div>
                    <div className="text-white font-bold text-lg">Interview-Ready System</div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">Memory Capture Templates</div>
                      <div className="text-gray-400 text-xs">Extract details before they fade</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                    <svg className="w-5 h-5 text-[#FD7E35] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">NDA-Safe Framework</div>
                      <div className="text-gray-400 text-xs">Show confidential work legally</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                    <svg className="w-5 h-5 text-[#FD7E35] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">Senior Positioning Scripts</div>
                      <div className="text-gray-400 text-xs">Lead with strategy, not pixels</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-3 bg-white/5 rounded-lg border border-white/5">
                    <svg className="w-5 h-5 text-[#FD7E35] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div>
                      <div className="text-white font-medium text-sm">2-Week Timeline</div>
                      <div className="text-gray-400 text-xs">Day-by-day execution plan</div>
                    </div>
                  </div>
                </div>
              </div>
