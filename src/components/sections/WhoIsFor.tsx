    ...
    <section className="relative py-24 bg-[var(--color-surface)] overflow-hidden">
      ...
      <Container className="relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {/* For you */}
          <div className="relative bg-[var(--color-surface-dark)] rounded-2xl p-8 border border-emerald-500/30 shadow-[0_0_30px_rgba(16,185,129,0.1)] hover:shadow-[0_0_40px_rgba(16,185,129,0.2)] transition-shadow duration-300">
            ...
            <div className="flex items-center gap-3 mb-6 relative z-10">
              ...
              <span className="text-lg font-semibold text-emerald-400">This is for you if:</span>
            </div>
